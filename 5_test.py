...
# TEST_IMAGE_DIR = os.getcwd() +  "/DroneImages"
# TEST_IMAGE_DIR =  r"C:\Users\HP\Desktop\Projects\Aerial-Detection-Faster-RCNN\DroneImages"
TEST_IMAGE_DIR =  r"Y:\l"
...
def main():
    ...
    with detection_graph.as_default():
        ...
        with tf.compat.v2.io.gfile.GFile(FROZEN_INFERENCE_GRAPH_LOC, 'rb') as fid:
